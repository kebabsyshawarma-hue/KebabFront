          ...
          <div className="xl:col-span-2 space-y-8">
            ...
            <section className="bg-white/5 border border-white/10 p-8 rounded-3xl shadow-2xl backdrop-blur-sm">
              ...
              {paymentMethod === 'transfer' && (
                <div className="mt-8 p-6 bg-gradient-to-br from-neutral-900 to-black border border-gold/30 rounded-2xl animate-in slide-in-from-top duration-500">
                  <div className="flex items-center justify-between mb-4">
                    <p className="text-gold font-bold flex items-center gap-2"><i className="bi bi-info-circle"></i> Datos para el pago</p>
                    <img src="/images/kebablogo.png" alt="Logo" className="h-8 opacity-50" />
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <p className="text-gray-500 text-xs uppercase tracking-tighter">Banco</p>
                      <p className="font-bold">BANCOLOMBIA</p>
                    </div>
                    <div>
                      <p className="text-gray-500 text-xs uppercase tracking-tighter">Tipo</p>
                      <p className="font-bold">AHORROS</p>
                    </div>
                    <div className="col-span-2 pt-2 border-t border-white/5">
                      <p className="text-gray-500 text-xs uppercase tracking-tighter">Número de Cuenta</p>
                      <div className="flex items-center justify-between">
                        <p className="text-xl font-mono font-bold tracking-widest text-gold">000-000000-00</p>
                        <button type="button" onClick={() => { navigator.clipboard.writeText('000-000000-00'); alert('Copiado'); }} 
                          className="p-2 hover:bg-white/10 rounded-lg text-gold transition-colors">
                  ...
                  <p className="mt-4 text-[11px] text-gray-500 italic">
                    * Finaliza tu pedido y envía el comprobante por WhatsApp para procesar tu orden.
                  </p>
                </div>
              )}
            </section>
