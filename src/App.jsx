...
import OrderStatusPage from './pages/status/OrderStatusPage.jsx'; // Import OrderStatusPage
  ...
  return (
    <AuthProvider>
      <Routes>
        ...
        <Route path="/status" element={<OrderStatusPage />} /> {/* Add OrderStatusPage route */}
